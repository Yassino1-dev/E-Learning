...
use App\CourseUser;
$coursesUser = CourseUser::where('user_id', Auth::user()->id)->get();//recuperer les cours auquels le participant est inscrit (on aura accès à cette variable dans notre vue)
                ...
                <li>
                    <div class="d-flex  ml-2 my-3">
                        ...
                        <div class="user-infos">
                            <a href="{{  route('participant.index')  }}"><small>{{ $courseUser->course->title }}</small></a>
                        </div>
                    </div>
                </li>
            @endforeach    
                ...
                <li>
                    <div class="d-flex">
                        ...
                        <div class="user-infos ml-3">
                            ...
                            <p class="text-danger">{{ $item->price }} Dhs</p>
                        </div>
                    </div>
                </li>
            @endforeach    
            ...
            <ul class="dropdown px-2 py-2 text-center">
                <li>
                    <div class="empty-cart">
                        ...
                        <a class="btn btn-link" href="{{ route('courses.index')  }}">Continuez votre découverte !</a>
                    </div>
                </li>
            </ul>
            @endif
