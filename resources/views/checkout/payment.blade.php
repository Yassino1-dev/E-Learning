        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <p><b>Prix total:</b></p>  
                        <p><b>{{ \Cart::getSubTotal() + $roundedTax }} Dhs</b></p>
                    </div>
...
var stripe = Stripe('pk_test_51HBSTiCAFojqCmYopnYOx2MteYzPwGEox3SduH2ZutpPH5AKHUoOCs9ntZOyuP30drWl0cxEVyygmeU9CdfbJHwC006FXNzIvd');
