...
class InstructorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $course->desc = $request->input('description');//entre parenthese se trouve dans la meth POST
    ...
    public function update(Request $request, $id)
    {
        ...
        $course->save();
        return redirect()->route('instructor.index')->with('success','Vos modifications ont été apportées aves succès !');
    }
    ...
    {
        $course = Course::find($id);//pour trouver le cours en question
        $course->delete();
    ...
    public function publish($id){
        ...
        return redirect()->back()->with('danger','Votre cours doit avoir un tarif défini ,ainsi q\'au moin une section video avant d\'être publiable.');
    }

    public function participants($id){
        $course = Course::find($id);
        $participants = Payment::where('course_id', $id)->get();
        
        return view('instructor.participants',[
            'course' => $course, //l'erreur etait qu'il fallait passer la variable à la page suivante
